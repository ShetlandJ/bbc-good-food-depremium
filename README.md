# Get around "BBC" Good Food's premium filters:

1. Create a new bookmark in your browser (I use Chrome, I haven't tested this on Firefox)
2. Paste this javascript into the URL part of the bookmark:

```javascript
javascript:var newWindow=window.open("","_blank","width=800,height=600"),prepList=document.getElementsByClassName("recipe__cook-and-prep list list--horizontal")[0].innerHTML,ingredients=document.getElementsByClassName("recipe__ingredients")[0].innerHTML,steps=document.getElementsByClassName("recipe__method-steps")[0].innerHTML,innerHTML=`
<!DOCTYPE html>
<html>
<head>
...
`;newWindow.document.write(innerHTML),newWindow.document.close();
```